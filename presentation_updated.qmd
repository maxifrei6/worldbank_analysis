...
presentation_hiv_plot1_update
```

## 2.1 HIV {.custom-smaller}

```{r, fig.height=7, fig.width=12}
presentation_hiv_plot2_update
```
...
```{r, fig.height=7, fig.width=12}
presentation_hiv_plot3_update
```

## 2.1 HIV {.custom-smaller}

```{r, fig.height=7, fig.width=12}
presentation_hiv_plot4_update
```
...
-   ( \delta ) (default: **1.345**) controls robustness
...
-   ( SE(\hat{y}) ) is **approximated via local smoothing**
-   ( t\_{\alpha/2, df} ) is the **critical t-value**
