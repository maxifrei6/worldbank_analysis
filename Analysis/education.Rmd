...
ggplot(data_education, aes(x = GC.DOD.TOTL.GD.ZS, y = SL.TLF.BASC.ZS)) +
  geom_point(alpha = 0.6) +
  geom_smooth(method = MASS::rlm, se = FALSE, color = "black", alpha = 0.2) +
  facet_wrap(~ Year) +
  labs(
    title = "Central Government Debt vs Labor Force with Basic Education",
    x = "Central Government Debt (% of GDP)",
...
# German plot for presentation: Central government debt vs labor force with basic education
p12 <- ggplot(data_education, aes(x = GC.DOD.TOTL.GD.ZS, y = SL.TLF.BASC.ZS, color = cat_income_level)) +
  geom_point(size = 3.5, alpha = 0.6) +
  geom_smooth(aes(color = cat_income_level), method = MASS::rlm, color = "black", alpha = 0.2) +
  labs(
    title = "Zentralstaatliche Verschuldung vs. Grundbildung",
...
# German plot for presentation: Faceted scatter plot of Debt vs Education by Income Level
p22 <- ggplot(data_with_cor, aes(x = GC.DOD.TOTL.GD.ZS, y = SL.TLF.BASC.ZS)) +
  geom_point(size = 3.5, alpha = 0.6) +
...
# German plot for presentation: Scatter plot: pupil-teacher ratios vs labor force with basic education
p42 <- ggplot(data_education, aes(x = SE.TER.ENRL.TC.ZS, y = SL.TLF.BASC.ZS)) +
  geom_point(aes(color = cat_population_density), size = 3.5, alpha = 0.6) +
  geom_smooth(method = MASS::rlm, color = "black", alpha = 0.2) +
  labs(
    title = "Schüler-Lehrer-Relation vs. Grundbildung",
...
p52 <- ggplot(data_with_cor, aes(x = SE.TER.ENRL.TC.ZS, y = SL.TLF.BASC.ZS)) +
  geom_point(alpha = 0.6, size = 3.5) +
  geom_smooth(method = MASS::rlm, color = "black", alpha = 0.2) +
  facet_wrap(~ cat_population_density, labeller = labeller(cat_population_density = facet_labels)) +
  labs(
...
ggplot(data_education, aes(x = SE.TER.ENRL.TC.ZS, y = NY.GDP.PCAP.PP.KD, fill = cat_population_density)) +
  ...
  geom_smooth(aes(color = cat_population_density), method = MASS::rlm, show.legend = FALSE, alpha = 0.1) +
...
p62 <- ggplot(data_education, aes(x = SE.TER.ENRL.TC.ZS, y = NY.GDP.PCAP.PP.KD, fill = cat_population_density)) +
  geom_point(size = 3.5, shape = 21, alpha = 0.4) +
