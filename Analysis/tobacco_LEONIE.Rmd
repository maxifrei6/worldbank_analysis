...
```{r}
## testing new function in function skript. grouping by tobacco values of year 2020
## function 2.2 group_data_year
group_data_year(df = data_tob, grouping_by = "SH.PRV.SMOK", year = "2020", column_new = "tob_usage", quantile_labels = c("Sehr gering", "Gering", "Mittel", "Viel", "Sehr Viel"))
```
