...
data_tob_cat_year <- for (year in as.character(data_table$Year)) {
  ...
  new_cat <- group_data_year(df = data_tob_cat_year, grouping_by = "SH.PRV.SMOK", year = "2020", column_new = "tob_usage", quantile_labels = c("Sehr gering", "Gering", "Mittel", "Viel", "Sehr Viel"))
