...
<br>
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.align = "left"}
data_tob_per_year <- data_tob_cat_year %>%
  group_by(Year) %>%
  mutate(cat_tob_usage_per_year = 
           group_data_year(df = data_tob_cat_year, grouping_by = "SH.PRV.SMOK", year = Year, column_new = "tob_usage_per_year", quantile_labels = c("Sehr gering", "Gering", "Mittel", "Viel", "Sehr Viel"))$cat_tob_usage_per_year)

# data_tob_cat_year <- for (year in as.character(data_table$Year)) {
# 
#   new_cat <- group_data_year(df = data_tob_cat_year, grouping_by = "SH.PRV.SMOK", year = year, column_new = "tob_usage_per_year", quantile_labels = c("Sehr gering", "Gering", "Mittel", "Viel", "Sehr Viel"))
# 
...
```
<br>
und nun barplot faccetiert nach jahr, x: gruppiert nach tabakdurchschnittskonsum und dann bip geplottet
<br>
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.align = "left"}
data_tob %>%
  group_by(cat_tob_usage) %>%
