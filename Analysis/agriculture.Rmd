...
<br><br>
For this analysis specifically, we constrain ourselves to indicators such as countries' percentage of agricultural land, CO<sub>2</sub> emissions per capita in megatonnes, the size of surface area in square kilometers, and total population using World Bank data. The exploration is divided into two research questions, namely:
<br><br>
...
```{r scatter_agrland_co2, echo=FALSE, fig.height=7, fig.width=12, message=FALSE, warning=FALSE}
