...
The dataset we have been provided with contains longitudinal observations of in total 25 countries with 18 indicators each. The yearly data acquisition happened from 2000 to 2021. The upon mentioned indicators taken into consideration for this analysis are defined in the following table.
...
```{r pointline_faceted_agr, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
# Country-faceted line plot displaying the development of agricultural land [%] ordered by
# ascending mean [%]
pointline_faceted_agr <- 
...
```{r boxplot_agr, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
# Compute the between-country variance in CO2 emissions
...
```{r scatter_agr_co2, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
...
```{r scatter_faceted_agr_co2, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
# Logarithmic CO2 emissions by country, average agricultural land [%] for color and
# faceting order
scatter_faceted_agr_co2 <-
...
```{r scatter_faceted_normd_agr_co2, echo=FALSE, fig.height=9, fig.width=15, message=FALSE, warning=FALSE}
...
```{r pointline_faceted_srf, echo=FALSE, fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
...
```{r changing_obs_absolute_srf, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
...
# absolute changes
barplot_absolute_changes_surface <-
...
```{r changing_obs_relative_srf, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
...
pointline_relative_changes_surface <-
...
```{r scatter_grouped_srf, echo=FALSE, fig.height=7, fig.width=12, message=FALSE, warning=FALSE}
...
```{r scatter_faceted_grouped_srf, echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE}
# Plot the initial comparison via scatter plot, faceted by the grouped categories
scatter_faceted_grouped_agr_co2 <-
  ggplot(data_surface, aes(x = AG.LND.AGRI.ZS, y = log10(EN.GHG.CO2.MT.CE.AR5 + 1))) +
  geom_point(alpha = .3, size = 3.5) +
  scale_x_continuous(name = "Landwirtschaftliche Nutzfläche [%]",
...
```{r scatter_faceted_grouped_colored_srf, echo=FALSE, fig.height=7, fig.width=12, message=FALSE, warning=FALSE}
# Logarithmic CO2 emissions by country, average agricultural land [%] for color - faceted
# by groups
scatter_faceted_grouped_colored_surface <-
...
```{r scatter_faceted_grouped_normd_srf, echo=FALSE, fig.height=7, fig.width=12, message=FALSE, warning=FALSE}
# (Min; Max)-normalize variable CO2 emissions to same scale as agricultural land [%] and
# normalize agricultural land to compare relative changes within both variables
...
scatter_faceted_grouped_normd_agr_co2 <-
...
pres_updated_agriculture_plot3 <-
  ...
  scale_fill_manual(values = c(agr_normd = brewer.pal(3, "Set2")[[2]],
                               co2_normd = brewer.pal(3, "Set2")[[3]])) +
  theme(plot.title = element_text(size = 16.25))
...
```{r agriculture_save_pngs, error=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
pngs <- list(
  list(file = "heatmap_co2.png", plot = presentation_agriculture_backup1,
       height = 8, width = 14),
  list(file = "boxplot_co2.png", plot = presentation_agriculture_backup2,
       height = 8, width = 14),
  list(file = "pointline_faceted_agr.png", plot = pointline_faceted_agr,
       height = 6, width = 10),
  list(file = "boxplot_agr.png", plot = presentation_agriculture_backup3,
       height = 8, width = 14),
  list(file = "scatter_agr_co2.png", plot = presentation_agriculture_plot1,
       height = 7, width = 12),
  list(file = "scatter_agr_co2_updated.png", plot = pres_updated_agriculture_plot1,
       height = 7, width = 12),
  list(file = "scatter_faceted_agr_co2.png", plot = scatter_faceted_agr_co2,
       height = 6, width = 10),
  list(file = "scatter_faceted_normd_agr_co2.png",
       plot = presentation_agriculture_backup4, height = 9, width = 15),
  list(file = "scatter_faceted_normd_agr_co2_updated.png",
       plot = pres_updated_agriculture_backup4, height = 9, width = 15),
  list(file = "pointline_faceted_srf.png", plot = pointline_faceted_surface,
       height = 8, width = 12),
  list(file = "barplot_absolute_change_srf.png", plot = barplot_absolute_changes_surface,
       height = 6, width = 10),
  list(file = "pointline_relative_change_srf.png",
       plot = pointline_relative_changes_surface, height = 6, width = 10),
  list(file = "boxplot_srf.png", plot = pres_updated_agriculture_backup5,
       height = 6, width = 10),
  list(file = "scatter_grouped_agr_co2.png", plot = pres_updated_agriculture_backup6,
       height = 7, width = 12),
  list(file = "scatter_faceted_grouped_agr_co2.png",
       plot = presentation_agriculture_plot2, height = 8, width = 14),
  list(file = "scatter_faceted_grouped_agr_co2_updated.png",
       plot = pres_updated_agriculture_plot2, height = 8, width = 14),
  list(file = "scatter_faceted_grouped_colored_agr_co2.png",
       plot = scatter_faceted_grouped_colored_surface, height = 7, width = 12),
  list(file = "scatter_faceted_grouped_normd_agr_co2.png",
       plot = presentation_agriculture_plot3, height = 7, width = 12),
  list(file = "scatter_faceted_grouped_normd_agr_co2_updated.png",
       plot = pres_updated_agriculture_plot3, height = 7, width = 12)
  )

# Use lapply to apply ggsave to each element in the list
lapply(pngs, function(x) {
  ggsave(filename = x$file, plot = x$plot, path = here("Results", "Agriculture"),
