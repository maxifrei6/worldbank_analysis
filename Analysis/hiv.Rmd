...
The data is grouped by the variables we want to observe. To do this, we grouped the countries by the quantiles of the average values of the corresponding variable. In the following, the variables were devided into five categories. 
<br>
...
presentation_hiv_plot1 <- data_alc %>%
  ...
  labs(x = "Alkoholkonsum pro Kopf [l]", y = "HIV Prävalenz [%]", title = "Alkoholkonsum vs. HIV") +
  theme_bw() +
  theme(
...
presentation_hiv_backup2 <- data_alc_per_year %>%
  ...
  scale_fill_viridis_d(name = "relativer Alkoholkonsum",
                       ...
                       direction = -1) +
  facet_wrap(~ Year) +
  labs(x = "Alkoholkonsum pro Kopf [l]", y = "HIV Prävalenz [%]", title = "Jährliche Gruppierung der Daten") +
  theme_bw() +
  theme(
    axis.text = element_text(size = 14),
    axis.title.x = element_text(margin = margin(t = 10), size = 18),
...
edu_hiv_2021 <- data_edu %>%
  ...
  scale_fill_viridis_d(name = "relativer Anteil an Erwerbstätigen\nmit grundlegender Bildung",
                       option = "plasma",
                       direction = -1) +
...
```
<br>
The 60 % of our countries with relative higher education level also show a higher HIV Prevalence. Their Prevalence is falling over the years, while countries with lower education level have an small tendency to increasing HIV prevalence. The labor force with relative great educated labor force have a higher HIV Prevalence than the others.
<br>
...
# Grouping by basic education values each year and saving this full dataset in data_edu_per year using function 2.2 group_data_year
...
x_labels <- paste0(sort(unique(data_edu_per_year$cat_edu_per_year)), "\nn = ", data_edu_cat_n$n)
...
<br>
<br>
From the last few plots, it is very clear that a higher proportion of workers with basic education in a country is also associated with a higher HIV prevalence. So this question is negated in terms of the data.
...
pngs <- list(
  list(file = "pres_alc_hiv_dotplot.png", plot = presentation_hiv_plot1,
       height = 8, width = 14),
  list(file = "pres_alc_hiv_dotplot_rlm.png", plot = presentation_hiv_backup1,
       height = 8, width = 14),
  list(file = "pres_updated_alc_hiv_dotplot.png", plot = pres_updated_hiv_plot1,
       height = 8, width = 14),
  list(file = "pres_updated_alc_hiv_dotplot_rlm.png", plot = presentation_hiv_backup1_update,
       height = 8, width = 14),
  list(file = "country_alc_grouping.png", plot = country_alc_grouping,
       height = 8, width = 14),
  list(file = "alc_hiv_2020.png", plot = alc_hiv_2020,
       height = 8, width = 14),
  list(file = "year_hiv_grouped_alc.png", plot = year_hiv_grouped,
       height = 8, width = 14),
  list(file = "alc_hiv_barplot.png", plot = alc_hiv_barplot, 
       height = 8, width = 14),
  list(file = "pres_alc_hiv_facetyear_yearlygrouped.png", 
       plot = presentation_hiv_backup2, height = 8, width = 14),
  list(file = "pres_updated_alc_hiv_facetyear_yearlygrouped.png", 
       plot = presentation_hiv_backup2_update, height = 8, width = 14),
  list(file = "alc_hiv_mean_per_group_yearly.png", 
       plot = alc_hiv_mean_per_group_yearly, height = 8, width = 14),
  list(file = "pres_alc_hiv_boxplot_yearlygrouped.png",
       plot = presentation_hiv_plot2, height = 8, width = 14),
  list(file = "pres_updated_alc_hiv_boxplot_yearlygrouped.png", 
       plot = pres_updated_hiv_plot2, height = 8, width = 14),
  list(file = "alc_hiv_barplot_yearlygrouped.png", 
       plot = alc_hiv_barplot_yearlygrouped, height = 8, width = 14),
  list(file = "edu_hiv_2021_grouping.png",
       plot = edu_hiv_2021, height = 8, width = 14),
  list(file = "year_hiv_grouped_edu.png",
       plot = year_hiv_grouped_edu, height = 8, width = 14),
  list(file = "year_hiv_facetedu.png",
       plot = year_hiv_facetedu, height = 8, width = 14),
  list(file = "edu_hiv_barplot.png",
       plot = edu_hiv_barplot, height = 8, width = 14),
  list(file = "edu_hiv_dotplot.png",
       plot = edu_hiv_dotplot, height = 8, width = 14),
  list(file = "pres_edu_hiv_dotplot_yearlygrouped.png",
       plot = presentation_hiv_backup3, height = 8, width = 14),
  list(file = "pres_updated_edu_hiv_dotplot_yearlygrouped.png",
       plot = presentation_hiv_backup3_update, height = 8, width = 14),
  list(file = "pres_edu_hiv_mean_per_group_yearly.png",
       plot = presentation_hiv_plot3, height = 8, width = 14),
  list(file = "pres_updated_edu_hiv_mean_per_group_yearly.png",
       plot = pres_updated_hiv_plot3, height = 8, width = 14),
  list(file = "pres_edu_hiv_boxplot",
       plot = presentation_hiv_plot4, height = 8, width = 14),
  list(file = "pres_updated_edu_hiv_boxplot",
