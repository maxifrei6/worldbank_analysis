...
institute: "Dr. Fabian Scheipl, Daniel Schlichting"
date: "2025-01-20"
format: 
  revealjs:
...
# data for tobacco vs BIP Leonie
...
-   Jährliche Messungen für Zeitraum von 22 Jahren (2000 - 2021)
:::
...
```{r, fig.height=9, fig.width=20, message=FALSE, warning=FALSE, echo=FALSE}
...
grid.arrange(plot_1, plot_2, ncol = 2, widths = c(2, 3))
```
...
```{r, message=FALSE, fig.height=8, fig.width=12, warning=FALSE, echo=FALSE}
data_edu %>%
  group_by(cat_edu_per_year) %>%
  summarise(
    SH.DYN.AIDS.ZS = mean(SH.DYN.AIDS.ZS, na.rm = TRUE),
...
```{r tobacco_plot1_, echo = FALSE, warning=FALSE, message=FALSE}
data_tob %>%
