...
3.  Ausblick und weitere Schritte
:::
...
## 2.2 HIV (2/4) {.custom-smaller}

```{r, fig.height=7, fig.width=12}
plot_alc_hiv_boxplot
```

## 2.2 HIV (3/4) {.custom-smaller}
...
## 2.3 Bildung (1/6) {.custom-smaller}
...
## 2.3 Bildung (2/6) {.custom-smaller}

```{r edu_slide_2}
p2
```

## 2.3 Bildung (3/6) {.custom-smaller}

```{r edu_slide_3}
#p3
```

## 2.3 Bildung (4/6) {.custom-smaller}
...
## 2.3 Bildung (5/6) {.custom-smaller}

Sind Länder mit einem höheren Prozentsatz an Erwerbstätigen mit Grundbildung in der Lage, eine **niedrigere** Schüler-Lehrer-Relation beizubehalten?

```{r edu_slide_5}
p5
```

## 2.3 Bildung (6/6) {.custom-smaller}

und welche Auswirkungen könnte dies auf die Bildungsqualität haben?
